...
SYSTEM_PROMPT = (
    ...
    "Если на запрос нет ответов безопасного содержания — прямо скажи: 'Нет безопасного ответа'. Важно разделять когда просто нет ответа тогда просто напиши 'Я не знаю' и если нет безопасного ответа."
